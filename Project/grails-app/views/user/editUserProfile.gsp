...
<div class="row" >
            ...
            <div class="row">
                ...
                <div class="col-sm-8">
                    <div class="row">
                        ...
                        <div class="col-sm-6">${user.getCount()}</div>
                        <div class="col-sm-6">${user.getCount()}</div>
        ...
        <div id="border1">
            ...
            <g:each in="${com.rxlogix.Topic.findAllByUser(user)}">
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <div class="row">
                            <div class="col-sm-9"><b><a href="#">${it.name}</a> </b></div>
                        </div>
                        <hr>
                        <div class="row">
    ...
    <div class="col-sm-7" >
        <div id="border1">
            <b>Profile</b><hr>
            <div class="col-sm-12">
                <g:form controller="user" action="editUser" class="form-group" enctype="multipart/form-data" >
                    <div>
                        <label >First Name*</label>
                        <input style="float: right;" type="text" name="firstName">
                    </div><br>
                    <div>
                        <label >Last Name*</label>
                        <input style="float: right;" type="text" name="lastName">
                    </div><br>
                    <div>
            ...
            <div class="col-sm-12">
                <g:form controller="user" action="editUser" class="form-group" enctype="multipart/form-data">
                    <div>
                        ...
                        <input style="float: right;" type="password" name="password">
                    </div><br>
                    <div>
                        <label >Confirm Password</label>
                        <input style="float: right;" type="password" name="cnf_password">
                    </div><br>
                    <div>
                        <button type="submit" class="btn btn-primary">Update</button>
                    </div>
