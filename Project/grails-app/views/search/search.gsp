    ...
    <div class="row" id="div">
        ...
        <div class="col-sm-6">
            <div class="row" style="float: right;">
                <div>
                    <g:form class="form-group" controller="search" action="search">
                            <input type="text" placeholder="Search.." id="search" name="search">
                            <button type="submit" class="btn"><i class="fa fa-search" style="color: black;" aria-hidden="true"></i></button>
                    </g:form>
                </div>&nbsp&nbsp&nbsp&nbsp

            %{--&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp--}%

                <button type="button" class="btn"  data-target="#shareResource" data-toggle="modal" style="height: 38px"><i class="fa fa-link" aria-hidden="true"></i></button>&nbsp&nbsp
                                    ...
                                    <form>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="select-text" name="topic" style="width: 100px;" required>
                                                <g:each in="${com.rxlogix.Subscription.findAllByUser(com.rxlogix.User.get(session.getAttribute("id"))).topic}">
                ...
                <button type="button" class="btn"  data-target="#shareDocument" data-toggle="modal" style="height: 38px"><i class="fa fa-file" aria-hidden="true"></i></button>&nbsp&nbsp
    ...
    <div class="row">
        ...
        <div class="col-sm-5" >
            <div class="border1">
                ...
                <g:each in="${topicList}" id="topicSearch">
                    <div class="row">
                        <div class="col-sm-4">
                            <img src="https://grails.org/images/grails_logo.svg" style="border-radius: 20%; height: 120px; width: 110px;">
                        </div>
                        <div class="col-sm-8">
                            <a href="#">${it.name}</a> ${it.visibilityEnum}
                            <hr>
                            <div class="row">
                                <div class="col-sm-4">
                                    @${it.user.userName}
                                ...
                                <div class="col-sm-5">
                                    Subscriptions
                                    <a href="#">${com.rxlogix.Subscription.countByTopic(it)}</a>
                                </div>
                                <div class="col-sm-3">
                                    Post
                                    <a href="#">${com.rxlogix.Resources.countByTopic(it)}</a>
                                </div>
                            </div>
                        </div>
                    </div><hr>
